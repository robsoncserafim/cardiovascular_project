...
- **Machine Learning:**
    - **XGBoost** Classification Machine Learning Model to predict the presence or absence of a Cardiovascular disease. This model leverages the power of data to make accurate predictions and assist in healthcare decision-making.
