...
# Load the data
df= pd.read_csv('cardio_disease_dataset.csv', delimiter = ';', nrows = None)  # Replace 'your_dataset.csv' with your actual dataset filename
...
st.sidebar.markdown ("# Project Menu")
st.sidebar.markdown ("""---""")
...
image = Image.open ('cardio_binary.jpg')
# Insert image
...
if show_graph3:
    ...
    # Conclusion
    st.write("The representation demonstrates a **turnaround that occurs after the age of 50**, when the number of patients **with heart disease exceeds that of patients without heart disease** in the sample.")
